...
my $scriptDir = cwd();
my $fullPath = $scriptDir . "/Results/TestPage_2Jpg.jpg ";
...
if (!($PDFCreatorQueue)->WaitForJob(10)){
    ...
    Tkx::tk___messageBox(-message => "Applying jpeg settings...");
    ...
    Tkx::tk___messageBox(-message => "Converting under \"JpegGuid\" conversion profile");
