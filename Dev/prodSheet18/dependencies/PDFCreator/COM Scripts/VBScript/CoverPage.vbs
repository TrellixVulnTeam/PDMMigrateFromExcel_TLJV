...
fullPath = objFSO.GetParentFolderName(WScript.ScriptFullname ) & "\TestPage_WithCover.pdf " 
...
if not PDFCreatorQueue.WaitForJob(10) then
    ...
    printJob.SetProfileSetting "CoverPage.File", objFSO.GetParentFolderName(WScript.ScriptFullname) & "\\FilesForTests\\CoverPage.pdf"
